/* autogenerated by Processing revision 1276 on 2022-05-13 */
...
// General Attractor(x, y, z, xoffset, yoffset, power, noise, step, scale, startColor, endColor, iso, dx, dy,dz);
 ...
 public void setup() {
  ...
  attractors.add(new Attractor("Lorenze", 1, 0, 0, 0, 0, 1, 0, .005f, 20, 90, 155, false, "10*(-x+y)", "28*x-y-x*z", "x*y-(8/3)*z"));
  attractors.add(new Attractor("Halvorsen", 1, 0, 0, 0, 0, 1, 0, .005f, 40, 135, 200, true, "-1.4*x+-4*y+-4*z-y*y", "-4*x+-1.4*y+-4*z+-z*z", "-4*x+-4*y+-1.4*z+-x*x"));
  attractors.add(new Attractor("BurkeShaw", 1, 0, 0, 0, 0, 1, 0, .005f, 100, 180, 255, true, "-1*10*(x+y)", "((-1*x*y)/x)-10*x*z", "10*x*y+4.272"));
  attractors.add(new Attractor("Bouali", 1, .1f, .1f, 0, 0, 1, 0, .006f, 65, 20, 88, true, "x*(4-y)+ .3*z", "(1-(x*x))*(-1*y)", "-1*x*(y/y)*(1.5-z) - .05*z"));
  attractors.add(new Attractor("Spott-Linz", .1f, .1f, .1f, 0, 0, 1, 0, .01f, 150 , 160, 230, true, "(x/x)*y", "(-1*x)+y*z", "1-((x/x)*y*y)"));
  attractors.add(new Attractor("Nose-Hoover", 1, 0, 0, 0, 0, 1, 0, .009f, 100, 55, 134, true, "(x/x)*y", "(-1*x)+y*z", "1.5-(x/x)*y*y"));
